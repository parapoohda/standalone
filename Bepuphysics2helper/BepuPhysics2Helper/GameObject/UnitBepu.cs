...
{
    public class UnitBepu:IUnitBepu
    {
        public ColliderBepu collider;
        private string name;
        public string Name => name;
        private int unitId;
        public int UnitId => unitId;
        public enum ShapeEnum { Capsule }
        public ShapeEnum shapeCharacter;
        private int charId;
        ...
        public ShapeEnum ShapeCharacter => shapeCharacter;
        private CharacterInput characterInput;
        public CharacterInput CharacterInputt => characterInput;
        private float walkSpeed = 1f;
        private float runSpeed = 2f;
        private bool isCalculateVelocityYet = true;
        public bool IsCalculateVelocityYet => isCalculateVelocityYet;
        ...
        public System.Numerics.Vector3 Target
        {
            ...
            set
            {
                ...
                {
                    target = value;
                    isCalculateVelocityYet = false;
                }
            }
        }
        public enum BepuTypeId { Sphere, Capsule }
        public System.Numerics.Vector3 Position => new BepuPhysics.BodyReference(collider.bodyHandle, bepu.Simulation.Bodies).Pose.Position;
        public BodyVelocity VelocityInBepu => new BodyReference(collider.bodyHandle, bepu.Simulation.Bodies).Velocity;
        ...
        public System.Numerics.Vector3 ViewDirection => viewDirection;
        ...
        public UnitBepu(int unitId,int charId ,string name ,Bepu bepu, System.Numerics.Vector3 startPosition) {
            ...
            collider.type = ColliderBepu.Type.Unit;
            this.name = name;
            this.unitId = unitId;
            this.bepu = bepu;
         ...
         public System.Numerics.Vector3 GetStartPosition()
        {
        ...
        public void SetCharacterInput(CharacterControllers characterCTs, int bodyHandle, Simulation simulation)
        {
            collider.bodyHandle = bodyHandle;
        ...
        public BepuTypeId ShapeTypeId => shapeTypeId;
        public struct CharacterInput
        {
            ...
            public void UpdateCharacterGoals(Vector2 movementDirection, float effectiveSpeed, float simulationTimestepDuration)
            {
