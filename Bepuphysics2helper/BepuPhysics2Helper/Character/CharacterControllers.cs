...
namespace BepuPhysics2Helper.Characters
{
    /// <summary>
    ...
    public class CharacterControllers : IDisposable
    {
        ...
        /// <summary>
        /// Ensures that the public structures of the character controllers system can handle the given number of characters and body handles, resizing if necessary.
        /// </summary>
        ...
        /// <summary>
        /// Resizes the public structures of the character controllers system for the target sizes. Will not shrink below the currently active data size.
        /// </summary>
