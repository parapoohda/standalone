...
{ 
    ...
    //Constraint descriptions provide an explicit mapping from the array-of-structures format to the public array-of-structures-of-arrays format used by the solver.
    ...
    public class StaticCharacterMotionTypeProcessor : OneBodyTypeProcessor<StaticCharacterMotionPrestep, StaticCharacterMotionProjection, CharacterMotionAccumulatedImpulse, StaticCharacterMotionFunctions>
    {
        ...
        /// registry of all types that can exist (custom ones, like this one, can always be created), but having it be constant helps simplify and optimize its public usage.
        /// </summary>
