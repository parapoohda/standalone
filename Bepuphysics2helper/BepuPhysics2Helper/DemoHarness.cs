...
namespace BepuPhysics2Helper
{
    public class DemoHarness : IDisposable
    {
        ...
        internal DemoHarness(GameLoop loop,
        ...
        internal DemoHarness(GameLoop loop, ContentArchive content,
            Controls? controls = null)
        {
            this.window = loop.Window;
            this.input = loop.Input;
        ...
        public void Render(Renderer renderer)
        {
            ...
            //swapper.Draw(uiText, renderer.TextBatcher, "Map", new Vector2(16, 16), textHeight, textColor, font);
